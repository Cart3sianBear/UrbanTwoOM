...
equation
  connect(idealOpeningSwitch1.control, u) annotation(Line(points = {{-30, 68}, {-30, 68}, {-30, 76}, {0, 76}, {0, 100}, {0, 100}}, color = {255, 0, 255}));
  connect(idealDiode1.n, idealOpeningSwitch1.n) annotation(Line(points = {{40, 0}, {40, 60}, {-20, 60}}, color = {0, 0, 255}));
  connect(idealOpeningSwitch1.p, pin_p) annotation(Line(points = {{-40, 60}, {-100, 60}}, color = {0, 0, 255}));
  connect(idealOpeningSwitch1.n, pin_p1) annotation(Line(points = {{-20, 60}, {100, 60}}, color = {0, 0, 255}));
  connect(pin_n, idealDiode1.p) annotation(Line(points = {{-100, -60}, {40, -60}, {40, -20}}, color = {0, 0, 255}));
  connect(pin_n, pin_n1) annotation(Line(points = {{-100, -60}, {98, -60}, {98, -60}, {100, -60}}, color = {0, 0, 255}));
